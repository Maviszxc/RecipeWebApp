...
$searchBtn.addEventListener("click", function () {
  ...
  if (searchQuery) {
    window.location.href = `/home/recipes/?q=${encodeURIComponent(
      searchQuery
    )}`;
  }
});
...
const addTabContent = ($currentTabBtn, $currentTabPanel) => {
  ...
  fetchData(
    ...
    function (data) {
      ...
      $currentTabPanel.innerHTML += `
      <a href="/home/recipes" class="btn btn-secondary label-large has-state">Show more</a>
...
$sliderSections.forEach(($sliderSection, index) => {
  ...
  fetchData([...cardQueries, ["cuisineType", cuisineType]], function (data) {
    ...
    $sliderWrapper.innerHTML += `
      <li class="slider-item" data-slider-item>
        <a href="/home/recipes" class="load-more-card has-state">
